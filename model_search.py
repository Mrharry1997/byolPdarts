...
class Network(nn.Module):
    ...
    def __init__(self, C, out_dim, layers, steps=4, multiplier=4, stem_multiplier=3, switches_normal=[], switches_reduce=[], p=0.3):
...
#            cell = Cell(steps, multiplier, C_prev_prev, C_prev, C_curr, reduction, reduction_prev, switches)
        ...
        self.mlp = nn.Sequential(nn.Linear(C_prev, C_prev), nn.ReLU(), nn.Linear(C_prev, out_dim))
